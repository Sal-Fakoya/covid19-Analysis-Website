...
-   Then we did data validation to check for missing values in the
    moving averages. We should expect No missing values in the moving
    average, because the essence of the moving average is to smooth out
    the jumps in the time series.
